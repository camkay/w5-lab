...
We used R {[}Version 3.5.1; @{]} and the R-packages \emph{ggplot2}
(Version 3.0.0; Wickham, 2016), \emph{here} (Version 0.1; Müller, 2017),
\emph{janitor} (Version 1.1.1; Firke, 2018), \emph{papaja} (Version
0.1.0.9842; Aust \& Barth, 2018), \emph{rio} (Version 0.5.10; C.-h.
Chan, Chan, Leeper, \& Becker, 2018), and \emph{tidyverse} (Version
